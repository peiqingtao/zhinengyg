...
//更新
func AttrTypeUpdate(c *gin.Context) {
	// 1 确定资源 ID
...
//添加
func AttrTypeCreate(c *gin.Context) {
	// 1 得到模型
	m := model.AttrType{}
	// 2 从请求数据中绑定对象
	bindErr := c.ShouldBind(&m)
...
// 删除
func AttrTypeDelete(c *gin.Context) {
...
// 列表接口
func AttrTypeList(c *gin.Context) {
