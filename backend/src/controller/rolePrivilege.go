...
//更新
func RolePrivilegeUpdate(c *gin.Context) {
	// 1 确定资源 ID
...
//添加
func RolePrivilegeCreate(c *gin.Context) {
	// 1 得到模型
	m := model.RolePrivilege{}
	// 2 从请求数据中绑定对象
	bindErr := c.ShouldBind(&m)
...
// 删除
func RolePrivilegeDelete(c *gin.Context) {
...
// 列表接口
func RolePrivilegeList(c *gin.Context) {
