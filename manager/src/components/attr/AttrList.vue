<template>
  <div class>
    <el-row class="main-header">
      <el-col :span="12">
        <el-page-header content="属性列表"></el-page-header>
      </el-col>
      ...
      <el-form :model="itemSetForm" ref="itemSetForm" :rules="itemSetRules" label-width="140px">
        <el-tabs v-model="setDialogActiveName">
          <el-tab-pane label="基本信息" name="general">
            ...
            <el-form-item label="所属类型" prop="AttrTypeID">
							 <el-select v-model.number="currentType" placeholder="请选择" @change="handleTypeChange">
                <el-option
                  v-for="item in types"
                  :key="item.ID"
                  :label="item.Name"
            ...
            <el-form-item label="所属分组" prop="AttrGroupID">
              <el-select v-model="itemSetForm.AttrGroupID" placeholder="请选择">
                <el-option
          ...
          <el-row class="main-data">
            <el-col :span="24">
              ...
              >
                ...
                <el-table-column prop="AttrGroupID" label="所属分组" sortable="custom"></el-table-column>
                <el-table-column prop="Name" label="属性" sortable="custom"></el-table-column>
        ...
        <el-card class="box-card">
          ...
          <el-form :label-position="'top'" label-width="80px" :model="filterForm">
            <el-form-item label="所属分组">
              <el-input v-model="filterForm.filterAttrGroupID"></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    // type 改变
    handleTypeChange() {
      this.refreshGroups(this.currentType)
    },
    // 翻页-size改变
    ...
    // 添加
    itemSetAdd() {
      this.axios.post(base + "attr", this.itemSetForm).then(resp => {
        if (resp.data.error != "") {
          // 失败
          this.$message.error(resp.data.error);
          return;
    ...
    itemSetEdit() {
      this.axios
        .put(base + "attr", this.itemSetForm, {
          params: {
