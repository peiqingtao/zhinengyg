<template>
  <div class>
    <el-row class="main-header">
      <el-col :span="12">
        <el-page-header content="属性分组列表"></el-page-header>
      </el-col>
        ...
        <el-tabs v-model="setDialogActiveName">
          <el-tab-pane label="基本信息" name="general">
						...
						<el-form-item label="所属类型" prop="AttrTypeID">
							 <el-select v-model="itemSetForm.AttrTypeID" placeholder="请选择">
                <el-option
                  v-for="item in types"
                  :key="item.ID"
                  :label="item.Name"
            ...
            <el-col :span="24">
              ...
              >
                <el-table-column type="index" width="50"></el-table-column>
								<el-table-column prop="AttrType.Name" label="所属类型" sortable="custom"></el-table-column>
								<el-table-column prop="Name" label="属性分组" sortable="custom"></el-table-column>
        ...
        <el-card class="box-card">
          ...
          <el-form :label-position="'top'" label-width="80px" :model="filterForm">
						...
						<el-form-item label="所属类型">
							<el-input v-model="filterForm.filterAttrTypeID"></el-input>
						</el-form-item>
...
export default {
  ...
  methods: {
    ...
    // 添加
    itemSetAdd() {
      this.axios.post(base + "attr-group", this.itemSetForm).then(resp => {
        if (resp.data.error != "") {
          // 失败
          this.$message.error(resp.data.error);
          return;
    ...
    itemSetEdit() {
      this.axios
        .put(base + "attr-group", this.itemSetForm, {
          params: {
