<template>
  <div class>
    <el-row class="main-header">
      <el-col :span="12">
        <el-page-header content="属性类型列表"></el-page-header>
      </el-col>
            ...
            <el-col :span="24">
              ...
              >
                <el-table-column type="index" width="50"></el-table-column>
								<el-table-column prop="Name" label="属性类型" sortable="custom"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    // 添加
    itemSetAdd() {
      this.axios.post(base + "attr-type", this.itemSetForm).then(resp => {
        if (resp.data.error != "") {
          // 失败
          this.$message.error(resp.data.error);
          return;
    ...
    itemSetEdit() {
      this.axios
        .put(base + "attr-type", this.itemSetForm, {
          params: {
