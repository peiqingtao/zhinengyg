<template>
  <div class>
    <el-row class="main-header">
      <el-col :span="12">
        <el-page-header content="产品属性列表"></el-page-header>
      </el-col>
        ...
        <el-tabs v-model="setDialogActiveName">
          <el-tab-pane label="基本信息" name="general">
						...
						<el-form-item label="产品" prop="ProductID">
							<el-input v-model="itemSetForm.ProductID"></el-input>
						</el-form-item>
						<el-form-item label="属性" prop="AttrID">
							<el-input v-model="itemSetForm.AttrID"></el-input>
						</el-form-item>
						<el-form-item label="值" prop="Value">
							<el-input v-model="itemSetForm.Value"></el-input>
						</el-form-item>
            ...
            <el-col :span="24">
              ...
              >
                <el-table-column type="index" width="50"></el-table-column>
								<el-table-column prop="ProductID" label="产品" sortable="custom"></el-table-column>
								<el-table-column prop="AttrID" label="属性" sortable="custom"></el-table-column>
        ...
        <el-card class="box-card">
          ...
          <el-form :label-position="'top'" label-width="80px" :model="filterForm">
						...
						<el-form-item label="产品">
							<el-input v-model="filterForm.filterProductID"></el-input>
						</el-form-item>
						<el-form-item label="属性">
							<el-input v-model="filterForm.filterAttrID"></el-input>
						</el-form-item>
						<el-form-item label="值">
							<el-input v-model="filterForm.filterValue"></el-input>
						</el-form-item>            
            <el-form-item>
...
export default {
  ...
  methods: {
    ...
    // 添加
    itemSetAdd() {
      this.axios.post(base + "product-attr", this.itemSetForm).then(resp => {
        if (resp.data.error != "") {
          // 失败
          this.$message.error(resp.data.error);
          return;
    ...
    itemSetEdit() {
      this.axios
        .put(base + "product-attr", this.itemSetForm, {
          params: {
